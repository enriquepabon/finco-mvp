...
export default function DeprecatedBudgetChatPage() {
      ...
      <div className="max-w-lg w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Hemos actualizado la forma de crear presupuestos con una experiencia más moderna e intuitiva.
          </p>

          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <p className="text-sm text-blue-800">
              Redirigiendo a la nueva experiencia de creación de presupuestos...
            </p>
